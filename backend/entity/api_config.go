...
type APIConfig struct {
	...
	BaseURL   string         `gorm:"column:base_url;type:varchar(512)" json:"baseUrl,omitempty"`                  // 自定义API地址，用于代理或自部署场景
	Model     string         `gorm:"column:model;type:varchar(128)" json:"model,omitempty"`                       // 使用的模型名称，如gpt-4、claude-3等
