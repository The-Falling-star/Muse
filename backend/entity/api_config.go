...
type APIConfig struct {
	...
	UserID    int            `gorm:"column:user_id;not null;index:idx_api_configs_user_id" json:"userId"`                     // 所属用户ID
	...
	IsActive  bool           `gorm:"column:is_active;not null;default:false;index:idx_api_configs_is_active" json:"isActive"` // 是否为当前激活的配置
