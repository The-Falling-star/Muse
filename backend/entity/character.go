...
type Character struct {
	...
	Description     string   `gorm:"column:description;type:text" json:"description"`                    // 角色描述/人设，包含角色的性格、背景等信息
	FirstMessage    []string `gorm:"column:first_message;type:text;serializer:json" json:"firstMessage"` // 角色开场白，对话开始时角色发送的第一条消息
	ExampleDialogue string   `gorm:"column:example_dialogue;type:text" json:"exampleDialogue"`           // 示例对话，用于指导AI如何扮演该角色
