...
type UserSetting struct {
	ID             int       `gorm:"column:id;primaryKey;autoIncrement" json:"id"`                              // 设置唯一标识
	UserID         int       `gorm:"column:user_id;not null;uniqueIndex:uk_user_id" json:"userId"`              // 所属用户ID，一对一关系
	Theme          int       `gorm:"column:theme;not null;default:0" json:"theme"`                              // 主题设置：0-自动，1-浅色，2-深色
