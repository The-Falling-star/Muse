...
type WorldInfo struct {
	...
	UserID      int       `gorm:"column:user_id;not null;index:idx_world_infos_user_id" json:"userId"`                     // 所属用户ID
	...
	IsGlobal    bool      `gorm:"column:is_global;not null;default:false;index:idx_world_infos_is_global" json:"isGlobal"` // 是否为全局世界书，全局世界书对所有角色生效
...
type WorldInfoEntry struct {
	...
	WorldInfoID int    `gorm:"column:world_info_id;not null;index:idx_world_info_entries_world_info_id" json:"worldInfoId"` // 所属世界书ID
