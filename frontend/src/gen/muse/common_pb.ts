...
export enum ErrCode {
   ...
   * AI非正常输出
   *
   * @generated from enum value: AIExceptionOutput = 1001;
   */
 ...
 * FileType 文件类型枚举
 *
 * @generated from enum muse.FileType
 */
export enum FileType {
  /**
   * @generated from enum value: UploadFileTypeUnspecified = 0;
   */
  UploadFileTypeUnspecified = 0,

  /**
   * @generated from enum value: CharAvatar = 1;
   */
  CharAvatar = 1,

  /**
   * @generated from enum value: PersonaAvatar = 2;
   */
  PersonaAvatar = 2,
}

/**
 * Describes the enum muse.FileType.
 */
export const FileTypeSchema: GenEnum<FileType> = /*@__PURE__*/
  enumDesc(file_muse_common, 8);
