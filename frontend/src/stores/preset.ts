...
import type {PresetWithAll, PresetWithPromptLen, PromptItem} from '@/gen/muse/preset_pb';
import type {InjectionPosition, PromptItemIdentifier, Role} from '@/gen/muse/common_pb';
